    ...
    module Users
      ...
      def users(*args)
        ...
        flat_pmap(arguments.each_slice(MAX_USERS_PER_REQUEST)) do |users|
          perform_get_with_objects("/2/users/lookup.json", merge_users(arguments.options, users), Twitter::User)
        end
      end
      ...
      def user(*args)
        ...
        if arguments.last || user_id?
          ...
          perform_get_with_object("/2/users/show.json", arguments.options, Twitter::User)
        else
